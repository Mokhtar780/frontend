function LayoutAll() {
    ...
    <div className="layout-container " >
      ...
      <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme"
        style={{borderLeft: " 1px solid #00cfdd;" , borderRight: "1px solid #00cfdd;"}}>
        ...
        <ul className="menu-inner py-1 fontstyle">
          ...
          <li className="menu-item">
            <a className="menu-link fontstyle">
              <i className="menu-icon tf-icons bx bx-home-circle text-info"  style={{color:" #00cfdd;"}}></i>
          ...
          <li className="menu-item fontstyle">
            <a href="javascript:void(0);" className="menu-link menu-toggle fontstyle">
              <i className="menu-icon tf-icons fa fa-users  text-info"  style={{color:" #00cfdd;"}}></i>
              <span data-i18n=" ادارة المستخدمين  "> ادارة المستخدمين </span>
            </a>
            <ul className="menu-sub">
              ...
              <li className="menu-item ">
                <a className="menu-link  text-info">
                  <small>
                    <div data-i18n="   العمليات من قبل المستخدمين  "> العمليات من قبل المستخدمين </div>
                  </small>
                </a>
              </li>
            </ul>
          ...
          <li className="menu-item">
            ...
            <ul className="menu-sub">
              ...
              <li className="menu-item">
                <a className="menu-link text-info">
                  <small>
                    <div data-i18n="  أعداد اللجة االتحضيرية   "> أعداد اللجة االتحضيرية </div>
                  </small>
                </a>
              </li>
              ...
              <li className="menu-item">
                <a className="menu-link text-info">
                  <small>
                    <div data-i18n="  أعداد طاقم العمل   "> أعداد طاقم العمل </div>
                  </small>
                </a>
              </li>
              ...
              <li className="menu-item">
                <a className="menu-link text-info">
                  <small>
                    <div data-i18n="  أعداد الموازنة   "> أعداد الموازنة </div>
                  </small>
                </a>
              </li>
              {/*    end     أعداد الموازنة     */}
              ...
              <li className="menu-item">
                <a className="menu-link text-info">
                  <small>
                    <div data-i18n="   أعداد قائمة المدعوين  "> أعداد قائمة المدعوين </div>
                  </small>
                </a>
              </li>
              ...
              <li className="menu-item">
                <a className="menu-link text-info">
                  <small>
                    <div data-i18n="  أعداد قائمة المشاركين   "> أعداد قائمة المشاركين </div>
                  </small>
                </a>
              </li>
              ...
              <li className="menu-item">
                <a className="menu-link text-info">
                  <small>
                    <div data-i18n="   أعداد قائمة الزوار   "> أعداد قائمة الزوار </div>
                  </small>
                </a>
              </li>
      ...
      <div className="layout-page" >
        ...
        <nav className="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar"  style={{borderBottom:" 1px solid #00cfdd;"}}>
          <div className="container-fluid" >
             {/*  <hr />   */}
            <div className="layout-menu-toggle navbar-nav d-xl-none align-items-xl-center me-3 me-xl-0">
              <a className="nav-item nav-link px-0 me-xl-4" href="javascript:void(0)">
                <i className="bx bx-menu bx-sm"  style={{color:" #00cfdd;"}}></i>
              </a>
            </div>
               ...
               {/*  Language   */}
                ...
                <li className="nav-item me-2 me-xl-0">
                  <a className="nav-link style-switcher-toggle hide-arrow" href="javascript:void(0);">
                    <i className="bx bx-sm"  style={{color:" #00cfdd;"}}></i>
                  </a>
                </li>
                {/*  Style Switcher   */}
                ...
                <li className="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 me-xl-0">
                  <a className="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                    ...
                    <i className="bx bx-grid-alt bx-sm" style={{color:" #00cfdd;"}}></i>
                  </a>
                    ...
                    <div className="dropdown-menu-header border-bottom">
                      <div className="dropdown-header d-flex align-items-center py-3">
                        ...
                        <a href="javascript:void(0)" className="dropdown-shortcuts-add text-body" data-bs-toggle="tooltip"
                          data-bs-placement="top" title="Add shortcuts"><i className="bx bx-sm bx-plus-circle"  style={{color:" #00cfdd;"}}></i></a>
                      </div>
                    </div>
                ...
                <li className="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
                  <a className="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                    data-bs-auto-close="outside" aria-expanded="false">
                    <i className="bx bx-bell bx-sm"  style={{color:" #00cfdd;"}}></i>
                      ...
                      <div className="dropdown-header d-flex align-items-center py-3">
                        ...
                        <a href="javascript:void(0)" className="dropdown-notifications-all text-body"
                          data-bs-toggle="tooltip" data-bs-placement="top" title="Mark all as read"><i
                            className="bx fs-4 bx-envelope-open"  style={{color:" #00cfdd;"}}></i></a>
                      </div>
                    </li>
                          ...
                          <div className="d-flex">
                            <div className="flex-shrink-0 me-3">
                              <div className="avatar">
                                <img src="public/images/img/My-image.jpg" alt="" className="w-px-40 h-auto rounded-circle" />
                              </div>
                            </div>
                ...
                <li className="nav-item navbar-dropdown dropdown-user dropdown">
                  <a className="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div className="avatar avatar-online">
                      <img src="./src/assets/img/avatars/my4.jpg" alt="" className="rounded-circle" />
                    </div>
                  </a>
                  <ul className="dropdown-menu dropdown-menu-end">
                    <li>
                      <a className="dropdown-item" href="pages-account-settings-account.html">
                        <div className="d-flex">
                          <div className="flex-shrink-0 me-3">
                            <div className="avatar avatar-online">
                              <img src="./src/assets/img/avatars/hashem.jpg" alt="" className="rounded-circle" />
                            </div>
                          </div>
                          <div className="flex-grow-1">
